...
namespace memcache { namespace detail {
        ...
        >
    {
        ...
        qi::rule<std::string::const_iterator, std::string()> key;
        qi::rule<std::string::const_iterator, boost::uint16_t()> flags;
        qi::rule<std::string::const_iterator, size_t()> size;
        qi::rule<std::string::const_iterator, std::string(size_t)> data;
        qi::rule<std::string::const_iterator, boost::uint64_t()> cas;
